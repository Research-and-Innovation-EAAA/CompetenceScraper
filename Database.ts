...
export class Database {
    ...
    loadCompetencies() : Promise<Competence[]> {
        return new Promise((resolve,reject) => {
            ...
            let q = `SELECT _id, altLabels, conceptUri, description, name, lastMatch, lastUpdated, prefferredLabel, kompetencecol, defaultSearchPatterns, overriddenSearchPatterns, grp FROM ${COMPETENCE}`;
